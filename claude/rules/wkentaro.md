...
- When you post a PR/MR comment as part of processing it (e.g. a recommend-merge/recommend-close verdict), start it with a blockquote disclaimer `> *This was generated by AI during PR processing.*`
