...
au BufNewFile,BufRead *.md set tabstop=8 shiftwidth=2 ft=markdown colorcolumn=80 textwidth=79
...
au BufNewFile,BufRead *.tex set tabstop=8 shiftwidth=2 ft=tex colorcolumn=100 textwidth=79
